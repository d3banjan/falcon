"""Implement `falcon-secure audit` — enumerate and check unsafe escape sites."""
...
from ._config import get_falcon_secure_config, read_toml
...
TRUST_PROMOTION_FUNCS = {
    ("falcon_secure.trust", "trusted_path"): "trusted-path",
    ("falcon_secure.trust", "verify_path_sha256"): "trusted-path",
    ("falcon_secure.trust", "trusted_bytes"): "trusted-bytes",
    ("falcon_secure.trust", "verify_bytes_sha256"): "trusted-bytes",
    ("falcon_secure.trust", "trusted_binary_io"): "trusted-binary-io",
    ("falcon_secure.trust", "trusted_artifact"): "trusted-artifact",
}
...
def audit(
    ...
    config = get_falcon_secure_config(toml_data)

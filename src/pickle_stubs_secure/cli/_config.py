"""Parse [tool.pickle_secure] and checker config from pyproject.toml."""
...
def get_pickle_secure_config(toml_data: dict[str, Any]) -> dict[str, Any]:
    """Extract [tool.pickle_secure] config, return defaults if absent."""
    config = toml_data.get("tool", {}).get("pickle_secure", {})
    defaults = {

...
| CVE-2024-9701 | Kedro | `ShelveStore` reads | **Stubbed** as wrapper over `shelve`-backed reads. |
| CVE-2025-3108 | LlamaIndex | `JsonPickleSerializer` load/deserialize methods | **Stubbed** as pickle-fallback serializer surface. |

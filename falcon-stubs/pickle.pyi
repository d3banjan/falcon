"""Strict pickle stubs — every deserialization API returns Unsafe[Any].

Mutations vs typeshed:
  - loads() -> Unsafe[Any]      (was Any)
  - load()  -> Unsafe[Any]      (was Any)
  - Unpickler.load() -> Unsafe[Any]  (was Any)
  - _Unpickler.load() -> Unsafe[Any] (was Any)
...
# Re-export Unpickler from _pickle but with Unsafe return on .load()
# We define our own Unpickler that mirrors _pickle.Unpickler but with
# the mutated .load() return type.
